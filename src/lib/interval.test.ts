...
test.each([
	...
	const interval = new Interval(input);
...
test.each([
	...
	const interval1 = new Interval(input1);
	const interval2 = new Interval(input2);
	const actual = interval1.add(interval2);
	const expected = new Interval(output);
...
test.each([
	...
	const interval1 = new Interval(input1);
	const interval2 = new Interval(input2);
	const actual = interval1.sub(interval2);
	const expected = new Interval(output);
	expect(actual.valueOf()).toBeCloseTo(expected.valueOf(), 10);
});
...
test.each([
	...
	const interval1 = new Interval(frac);
